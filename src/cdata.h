...
#define	APPVERSIONSTR		"0.0.4.5p1"	/* application version as string */
#endif	/* #ifndef APPVERSIONSTR */

#ifndef	APPVERSION
#define	APPVERSION		1029	/* numeric version: major<<24|minor<<16|revisionmajor<<8|revisionminor */
