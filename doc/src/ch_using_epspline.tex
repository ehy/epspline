\chapter{Using \dtypkgu{}}
	...
	The prism is extended (like ``extrusion'') along the
	...
	(a plane is irrelevant since the lathe is rotated).
	...
	adds a \IXnewterm{rotate} transform to the prism objects
	...
	in the down direction. This is corrected easily using
	...
	since it is helpful to understand how \IXpov{} handles the
	prism and the lathe.
	...
	instance of \IXpkg{}.
		...
		Start \IXpkg{} without file arguments on the
		commandline, and the main window will open with
		one tab. The drawing area (the area with the grid
