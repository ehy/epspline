	...
	is shown in figure~\ref{fig:bezier_linked_control_points}.
		...
		items, and \IXpkg{} might use them.
			...
			\textsc{Item}: & \textsc{Keys}: & \textsc{Action}:\\ \hline
			\hline \hline
			Set Background Image & Ctrl+B & show a dialog to add or adjust a background image on the drawing area\\ \hline
			Hide Background Image & --- & toggle visibility of a background image appearing on the drawing area\\ \hline
			Remove Background Image & --- & remove a background image appearing on the drawing area\\ \hline
			\hline
			...
			Use Quick Drawing & --- & switch between anti-aliased, and not, outlines\\ \hline
			...
			These Tools \IXarg{menu} items need explanation:
			\begin{description}
			  ...
			  \item[Use Quick Drawing] The object outlines, the
			...
			Note on ``Use Quick Drawing'': above, it was said
			...
			``Use Quick Drawing'' and decide whether performance
			...
			The same caveat about quitting \IXpkg{} with
