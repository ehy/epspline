	...
	instance of \IXpkg{}.
		...
		provided by \IXpkg{} are discussed below.
			...
			curve, and should the point not be left in place.
			...
			depressing the control (or command) key, making
			...
			depressing the control (or command) key.
			
			Selected points may be deleted with the delete key
			(the edit \IXarg{menu} item will delete the
			whole object). In the case of the
			\IXbezn{} curve a whole segment must be
