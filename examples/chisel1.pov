...
#declare blade_unit_raw = object {
	ChiselBladeProfileTapered
	translate <
		-ChiselBladeProfileTapered_left-(ChiselBladeProfileTapered_width/2)
		, 0
		, -ChiselBladeProfileTapered_top-(ChiselBladeProfileTapered_height/2)
	>
...
#declare blade_unit_tang_cutter = object {
	...
	>
	scale <1, ChiselBladeProfileTapered_width, -1>
	rotate x*-90
	translate <-(ChiselBladeProfileTapered_width/6.6667)
		,-TangForm_height*.99
		,0>
}
...
#declare blade_unit_tang_cut = difference {
	...
	object {
		blade_unit_tang_cutter
		translate x*ChiselBladeProfileTapered_height/2.5
		rotate y*90
	}
	object {
		blade_unit_tang_cutter
	...
	object {
		blade_unit_tang_cutter
		translate x*ChiselBladeProfileTapered_height/5
		rotate y*270
	}
}
...
#declare blade_unit_grind_tang_cut = difference {
	...
	plane {
		y 0
		rotate x*-55.5
		translate <0, -2.0*(ChiselHandle_height+GrindForm_height*1.63), 0>
		hollow
...
#declare blade_unit = object {
	...
	scale 1.5/ChiselBladeProfileTapered_width
