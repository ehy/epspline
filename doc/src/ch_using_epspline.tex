\chapter{Using \dtypkgu{}}
	...
	\section{Necessary Transforms}%WX%3||||
	An example of the \IXarg{SDL} generated by \IXpkg{}
	...
	declaring ``INCLUDED\_foo\_inc.'' The guard will name will
	...
	by \IXpkg{} as the curve is \IXarg{interpolated},
	and are limited in accuracy by the resolution of the
	\IXarg{interpolation}, but should be precise enough
	for any scene.
